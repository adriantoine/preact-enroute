...
import assert from 'preact-assert-equal-jsx';
...
// Props
assert(
	<Router location="/list" items={['foo', 'bar', 'baz']}>
		<Route path="/" component={Index}>
...
assert(
	...
	<Index><Pets><Pet params={{petId: 12}}/></Pets></Index>
);
...
assert(
	...
	<Index><Users><User params={{userId: 5}}/></Users></Index>
);
